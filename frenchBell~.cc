//------------------------------------------------------------------------------
// Pd class `frenchBell~` generated by faust2pdex
//------------------------------------------------------------------------------
...
#define DSP_CC_FILENAME "./frenchBell.cc"

//------------------------------------------------------------------------------
// Static definitions from generator
//------------------------------------------------------------------------------
#define DSP_CLASS_NAME "frenchBell~"
#define DSP_SETUP frenchBell_tilde_setup
#define DSP_MAINSIGNALIN 0
#define DSP_NUM_CONTROLS 5
#define DSP_NUM_INPUTS 0
#define DSP_NUM_OUTPUTS 2
#define DSP_CONTROLS(F) \
    F("strikePosition", strikePosition, "strikePosition", true, true, 0, 4) \
    F("strikeCutOff", strikeCutOff, "strikeCutOff", true, true, 20, 20000) \
    F("strikeSharpness", strikeSharpness, "strikeSharpness", true, true, 0.01, 5) \
    F("gain", gain, "gain", true, true, 0, 1) \
    F("gate", gate, "gate", true, true, 0, 1)
//------------------------------------------------------------------------------
